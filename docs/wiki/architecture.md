...
| P8 | Cleanup: decouple read-only CLI from target config, host-binary runtime, `help` subcommand, `serve` loopback default | **scaffold done** — 2026-06-20 (item 5 deferred) |
